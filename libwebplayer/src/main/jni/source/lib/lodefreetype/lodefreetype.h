...
unsigned lodefreetype_decode_memory(void** out, unsigned* w, unsigned* h, const unsigned char* in, size_t insize);
...
unsigned draw_freetype_font(char** image, unsigned* w, unsigned* h, 
...
unsigned draw_stroke_font(	char** image, unsigned* w, unsigned* h, 
							void* font_info, unsigned long font_index, size_t font_size, unsigned char font_style,
							unsigned int x, unsigned int y, const char* str);
