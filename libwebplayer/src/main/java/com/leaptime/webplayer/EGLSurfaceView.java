...
public class EGLSurfaceView extends SurfaceView implements SurfaceHolder.Callback2 {
    ...
    private static class EglHelper {
        public EglHelper(WeakReference<EGLSurfaceView> glSurfaceViewWeakRef) {
        ...
        public void start() {
            ...
            EGLSurfaceView view = mGLSurfaceViewWeakRef.get();
            if (view == null) {
                mEglConfig = null;
                mEglContext = null;
            } else {
        ...
        private void destroySurfaceImp() {
            if (mEglSurface != null && mEglSurface != EGL10.EGL_NO_SURFACE) {
                mEgl.eglMakeCurrent(mEglDisplay, EGL10.EGL_NO_SURFACE,
                        ...
                        /*EGL10.EGL_NO_CONTEXT*/mEglContext);   //#ouley
                EGLSurfaceView view = mGLSurfaceViewWeakRef.get();
                if (view != null) {
        ...
        public void finish() {
            ...
            if (mEglContext != null) {
                EGLSurfaceView view = mGLSurfaceViewWeakRef.get();
                if (view != null) {
                    view.mRenderer.onDestroy();  //+ouley
        ...
        private WeakReference<EGLSurfaceView> mGLSurfaceViewWeakRef;
        EGL10 mEgl;
    ...
    static class GLThread extends Thread {
        GLThread(WeakReference<EGLSurfaceView> glSurfaceViewWeakRef) {
            super();
            mWidth = 0;
            mHeight = 0;
            mRequestRender = true;
