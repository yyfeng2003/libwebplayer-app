...
"use strict";
{
    ...
    window.RuntimeInterface = class e {
        ...
        async _InitDOM(n, a) {
            ...
            document.body.appendChild(this._canvas),
            window.c3canvas = this._canvas,
            window.screencanvas = this._canvas,  //+ouley
            this._domHandlers = i.map(e=>new e(this)),
            this._FindRuntimeDOMHandler();
        ...
        _ParseDataURI(t) {
            ...
            const a = t.substring(5, n)
              ...
              , s = d[2];
            let u;
            return u = "base64" === r || "base64" === s ? atob(o) : decodeURIComponent(o),
            {
                mime_type: e,
                data: u
            }
    ...
    const v = class extends DOMHandler {
        ...
        Attach() {
            ...
            "undefined" == typeof PointerEvent ? (
				window.addEventListener("mousedown", e=>this._OnMouseEventAsPointer("pointerdown", e)),
				...
				window.addEventListener("pointerdown", e=>this._OnPointerEvent("pointerdown", e)),
...
}
{
    ...
    const t = class extends DOMElementHandler {
        constructor(e) {
            super(e, "progress-bar")
        }
        CreateElement(t, n) {
            const a = document.createElement("progress");
            ...
            a.addEventListener("click", ()=>this._PostToRuntimeElementMaybeSync("click", t)),
            a.id = n.id,
        ...
        UpdateState(e, t) {
            ...
            const n = t.value
              , a = t.max;
            0 < a && 0 <= n ? (e.max = a,
            e.value = n) : (e.removeAttribute("value"),
    ...
    const t = class extends DOMHandler {
        ...
        *audioInstancesByTag(t) {
        ...
        async _GetAudioInstance(t, n, a, o, i) {
            ...
            const d = e.CreateInstance(o);
            return this._audioInstances.push(d),
            d
        }
        _AddPendingTag(e) {
        ...
        async _Play(t) {
            ...
            try {
                this._lastAudioInstance = await this._GetAudioInstance(n, a, o, e, d),
                i ? (
                ...
                this._lastAudioInstance.Play(r, s, u, l);
            } catch (e) {
        ...
        _SetEffectParam(t) {
            ...
            !r || 0 > a || a >= r.length || (r[a].SetParam(o, i, e, d),
            this._PostUpdatedFxState())
        }
        _RemoveEffects(e) {
...
self.C3AudioBuffer = class {
	...
	//+ouley
	static Create(t, n, a, o, i) {
		return new C3Html5AudioBuffer(t,n,a,o,i) 
    }
...
"use strict";
{
    ...
    self.C3AudioInstance = class {
        ...
        SetPan(n, a, o, i, e, d) {
            ...
            this._pannerNode.coneOuterGain = d)
        }
        SetPanXYA(e, t, n) {
...
"use strict";
{
    ...
    self.C3AudioPhaserFX = class extends e {
        constructor(t, n, a, o, i, e, d) {
            ...
            this._inputNode = this.CreateGain(),
            this._dryNode = this.CreateGain(),
            this._dryNode.gain.value = 1 - d / 2,
            this._wetNode = this.CreateGain(),
            this._wetNode.gain.value = d / 2,
            this._filterNode = this._audioContext.createBiquadFilter(),
